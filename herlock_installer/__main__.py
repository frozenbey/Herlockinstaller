...
def createApp (connect):
    appname = "herlock" + str(time() * 1000)[-4:].replace(".", "") + str(random.randint(0,500))
    try:
...
if __name__ == "__main__":
    ...
    onemli("(i) HerlockUserBot indiriliyor...")

    if os.path.isdir("./thoruserbot/"):
        del_it('./thoruserbot/')
    repo = Repo.clone_from("https://github.com/herlockexe/HerlockUserBot", "./herlockuserbot/", branch="main")
    basarili("(✓) HerlockUserBot indirildi!")
    ...
    config['SESSION_ADI'] = 'HerlockUserBot'
