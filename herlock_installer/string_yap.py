...
def stral():
    ...
    print("\033[00m")
    client = Client(':memory:',api_id="4150176",api_hash="cc60c01e601ee9cd77fe5ec6a6129882",app_version='TexeraUserBot',device_model='Texera',system_version='1.0',lang_code='tr',phone_number=phone)
    try:
        client.connect()
